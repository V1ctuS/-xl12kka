...
$LANG[40000] = "<br /><br />Cada ".$coinQntV." ".$coinName." cuesta un cierto valor, se describe a continuación, con bonificación automática del ".$buyCoins['bonus_percent'][1]."% para pedidos superiores a ".$buyCoins['bonus_count'][1]." ".$coinName."'s, ".$buyCoins['bonus_percent'][2]."% para compras superiores a ".$buyCoins['bonus_count'][2]." ".$coinName."'s y ".$buyCoins['bonus_percent'][3]."% para compras superiores a ".$buyCoins['bonus_count'][3]." ".$coinName."'s. Por ejemplo: Usted paga ".$buyCoins['bonus_count'][1]." y recibe ".intval($buyCoins['bonus_count'][1]+(($buyCoins['bonus_count'][1]*$buyCoins['bonus_percent'][1])/100))."; paga ".($buyCoins['bonus_count'][2]+50)." y recibe ".intval(($buyCoins['bonus_count'][2]+50)+((($buyCoins['bonus_count'][2]+50)*$buyCoins['bonus_percent'][2])/100))."; paga ".($buyCoins['bonus_count'][3]+200)." y recibe ".intval(($buyCoins['bonus_count'][3]+200)+((($buyCoins['bonus_count'][3]+200)*$buyCoins['bonus_percent'][3])/100)).".";
...
$LANG[39020] = "Seleccione el código del color abajo.";
$LANG[39021] = "Color";
