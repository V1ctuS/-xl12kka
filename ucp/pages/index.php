...
if(!empty($accData[0]['created_time']) && !is_numeric($accData[0]['created_time'])) { $accData[0]['created_time'] = strtotime($accData[0]['created_time']); }
		...
		if(count($findChars) == 0) {
			...
			<div class='infos actived'>
				<div class='lines'>
					...
					<div class='two'>".$LANG[39047]."<span>-</span></div>
