				...
				*/ ?>
				<td>
					<select style='min-width: 160px;' name='metodo_pgto' id='metodo_pgto'>
						...
						if(!empty($MercadoPago['actived'])) { echo "<option data-symbol='".$MercadoPago['symbol']."' value='MercadoPago'>MercadoPago</option>"; }
				...
				<td>
					<select style='min-width: 160px;' name='qtdCoins' id='qtdCoins'>
						...
						for($i=(10*$coinQntV), $c=(500*$coinQntV); $i <= $c; $i++) { if($i%(10*$coinQntV)==0) { echo "<option value='".$i."'>".$i." ".$coinName."'s</option>"; } }
						for($i=(550*$coinQntV), $c=(1000*$coinQntV); $i <= $c; $i++) { if($i%(50*$coinQntV)==0) { echo "<option value='".$i."'>".$i." ".$coinName."'s</option>"; } }
