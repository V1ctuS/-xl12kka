...
##                   Configuración                       ##
###########################################################
$server_name = 'L2Dandiarena'; // Server Nombre
$server_chronicle = 'Scions of Destiny'; // Server Chronicle
$server_url = 'www.L2Dandiarena.com'; // Introduzca exactamente la URL donde se encuentra este site (por ejemplo: www.l2server.com)
...
###########################################################
$admpass = 'mudar123'; // Contraseña del panel admin


###########################################################
##              Configuración del e-mail                 ##
###########################################################
$admin_email = 'admin@L2Dandiarena.com'; // E-mail que los jugadores pueden utilizar para ponerse en contacto
$server_email = 'no-reply@L2Dandiarena.com'; // E-mail utilizado para enviar mensajes automáticas (por ejemplo: no-reply@suservidor.com)
...
$SMTP_host = 'smtp.L2Dandiarena.com'; // Host SMTP
...
$SMTP_user = 'no-reply@L2Dandiarena.com'; // Usuario de autenticación SMTP (generalmente el correo electrónico remitente)
...
$facePage = 'https://www.facebook.com/L2Dandiarena/'; // Página en Facebook
...
$coinCur = 'R$'; // Moneda de esa cantidad
