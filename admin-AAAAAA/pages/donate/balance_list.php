...
<section class="content">
	...
	<div class='box-footer'>
		<a href='?page=balance_add&module=donate' class='btn btn-primary'>Añadir Saldo</a>
	</div>
	...
	<div class="box">
		...
		<div class="box-body">
			...
			<table class="table table-bordered">
				...
				if(count($consulta) == 0) {
					echo'<tr><td colspan="2">Ninguna información sobre el saldo encontrado.</td></tr>';
				} else {
					for($i =0, $c=count($consulta);$i < $c; $i++) {
						...
						<tr>
							...
							<td><a href='?page=balance_change&module=donate&account=".$consulta[$i]['account']."' class='btn btn-default'>Cambiar</a></td>
						</tr>
						";
					}
				}
