...
<section class="content-header">
	<h1>
		Cambiar <?php echo ($findGallery[0]['isvideo'] == '1' ? 'Vídeo' : 'Imagen'); ?>
	</h1>
	<ol class="breadcrumb">
		<li><i class="fa fa-image"></i> Galeria</li>
		<li class="active">Cambiar <?php echo ($findGallery[0]['isvideo'] == '1' ? 'Vídeo' : 'Imagen'); ?></li>
	</ol>
</section>
			...
			<div class="box-body">
				...
				<div class='box-footer'>
					...
					<div style='float:right;'>
						...
						<a href='?page=delete&module=gallery&gid=<?php echo $gid; ?>' title='Borrar' class='btn btn-danger'>Borrar</a>
					</div>
				</div>
