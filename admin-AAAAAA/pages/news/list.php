...
<section class="content">
	...
	<div class='box-footer'>
		<a href='?page=add&module=news' class='btn btn-primary'>Añadir Noticia</a>
	</div>
	...
	<div class="box">
		...
		<div class="box-body">
			...
			<table class="table table-bordered">
				...
				if(count($consulta) == 0) {
					echo'<tr><td colspan="4">No hay noticias!</td></tr>';
				} else {
					for($i=0, $c=count($consulta); $i < $c; $i++) {
						...
						<tr>
							...
							<td class='opcs'>
								<a href='?page=edit&module=news&nid=".$consulta[$i]['nid']."' title='Cambiar' class='btn btn-default'><i class='fa fa-edit'></i></a>
								<a href='?page=delete&module=news&nid=".$consulta[$i]['nid']."' title='Borrar' class='btn btn-danger'><i class='fa fa-remove'></i></a>
							</td>
						</tr>
						";
					}
